...
window.onload = function () {
  const firebaseConfig = {
    apiKey: "AIzaSyAeje2gxefot5WxTUfdxYe7M6XNDH7w6bY",
    authDomain: "chats-cace0.firebaseapp.com",
    projectId: "chats-cace0",
    storageBucket: "chats-cace0.appspot.com",
    messagingSenderId: "548146994692",
    appId: "1:548146994692:web:8dc9e3df972b3e834adf51",
    measurementId: "G-XLFESMESCZ"
  };
  ...
  class MEME_CHAT {
    ...
    create_title() {
      ...
      title.textContent = "Live Virtual Tour";
    ...
    create_chat() {
      ...
      chat_input_send.innerHTML = `<i class="far fa-share-square"></i>`;
